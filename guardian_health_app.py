...
/* ========================= EXPANDERS - CLEAN ICONS NO TEXT ========================= */
        ...
        /* NEW: Use a "+" sign for the closed expander */
        .streamlit-expanderHeader::after {
            ...
            font-size: 1.5rem !important; /* Made it slightly bigger */
            color: #667eea !important;
            transition: transform 0.3s ease !important;
            font-weight: bold !important;
        }
        
        /* NEW: Use a "−" (minus) sign and no rotation for the open expander */
        details[open] .streamlit-expanderHeader::after {
            content: "−" !important; /* This is a minus sign, not a dash */
            transform: translateY(-50%) rotate(0deg) !important; /* Removed rotation */
        }
